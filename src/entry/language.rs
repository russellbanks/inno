...
/// <https://github.com/jrsoftware/issrc/blob/is-6_4_3/Projects/Src/Shared.Struct.pas#L141>
#[derive(Clone)]
pub struct Language {
    name: PascalString,
...
impl Language {
    ...
    #[must_use]
    #[inline]
    pub fn dialog_font_size(&self) -> u32 {
    ...
    #[must_use]
    #[inline]
    pub fn dialog_font_standard_height(&self) -> u32 {
    ...
    #[must_use]
    #[inline]
    pub fn welcome_font_size(&self) -> u32 {
    ...
    #[must_use]
    #[inline]
    pub fn copyright_font_size(&self) -> u32 {
